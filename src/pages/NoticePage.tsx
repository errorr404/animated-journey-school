...
const NoticePage = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Noticeboard | NEES, Purnea";
  }, [notices]);
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Navbar />
      <main id="main-content" className="pt-24 pb-16 bg-gradient-to-br from-yellow-50 to-blue-50">
        <Container>
          <SectionTitle 
            title="School Noticeboard"
            description="Stay updated with the latest announcements, events, and important notices from our school."
            className="mb-12"
          />
